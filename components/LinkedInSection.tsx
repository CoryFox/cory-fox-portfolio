        ...
        <Reveal className="rounded-3xl border border-[color:var(--border)] bg-[linear-gradient(135deg,rgba(255,255,255,0.68),rgba(239,234,226,0.9))] p-6 shadow-[var(--shadow-soft)] sm:p-10">
          <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-end lg:gap-8">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl font-[family-name:var(--font-display)] text-[2.4rem] leading-[0.96] sm:text-5xl lg:text-6xl">
                {content.title}
              </h2>
              <p className="mt-5 max-w-2xl text-base leading-7 text-[color:var(--text-secondary)] sm:mt-6 sm:text-lg sm:leading-8">
                {content.description}
              </p>
            </div>
