...
- `rounded-[var(--...)]` caused a visible regression where expected radii disappeared
...
- GitHub source of truth is the nested repo at `/Users/coryfox/Desktop/Cory Fox Portfolio/cory-fox-portfolio`
- parent folder repo should not be used for future work
